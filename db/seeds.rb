...
User.create(:id => 1, :email => "jayxni@gmail.com", :first_name => "Jay", :last_name => "N", :phone_number => "(512)2312512", :unit_number => "3F", :password => "asdf", :password_confirmation => "asdf")
User.create(:id => 2, :email => "liane@gmail.com", :first_name => "Liane", :last_name => "P", :phone_number => "(512)2312512", :unit_number => "3F", :password => "asdf", :password_confirmation => "asdf")
User.create(:id => 3, :email => "tyler@gmail.com", :first_name => "Tyler", :last_name => "S", :phone_number => "(512)2312512", :unit_number => "3F", :password => "asdf", :password_confirmation => "asdf")
User.create(:id => 4, :email => "jolena@gmail.com", :first_name => "Jolena", :last_name => "B", :phone_number => "(512)2312512", :unit_number => "3F", :password => "asdf", :password_confirmation => "asdf")
User.create(:id => 5, :email => "sarah@gmail.com", :first_name => "Sarah", :last_name => "H", :phone_number => "(512)2312512", :unit_number => "3F", :password => "asdf", :password_confirmation => "asdf")
User.create(:id => 6, :email => "juan@gmail.com", :first_name => "Juan", :last_name => "P", :phone_number => "(512)2312512", :unit_number => "3F", :password => "asdf", :password_confirmation => "asdf")

# Thread 1

parent = Content.create(:user_id => 4, :title => "Guest Parking",
:description => "Hey All
\nI have a quick request for the guest space.  I'll need it for just about an hour or so this morning.
\nPlease let me know if this is a problem.
\n- Jolena")

Content.create(:parent_id => parent.id, :user_id => 4, :description => "Looks like Jeff is in both spaces.  Juan, can I borrow your spot for a bit?  So sorry - my friend is here right now.\n-Jolena")
Content.create(:parent_id => parent.id, :user_id => 3, :description => "If you're still looking for a spot, Stacy and I will be out for most of the day so you can use our spot.")

# Thread 2

parent = Content.create(:user_id => 4, :title => "Spot #9", :description => "Hi All –
...
parent = Content.create(:user_id => 2, :title => "Wall Repair",
...
Content.create(:parent_id => parent.id, :user_id => 4, :title => "Wall Repair",
...
parent = Content.create(:user_id => 1, :title => "Comcast Slow?",
:description => "Hey all,
...
Content.create(:parent_id => parent.id, :user_id => 3,
:description => "Sorry Jay, I have AT&T u verse.")

Content.create(:parent_id => parent.id, :user_id => 6,
:description => "Jay - I am also on Comcast. The speed has been spotty in the last 2 days.")

Content.create(:parent_id => parent.id, :user_id => 1,
...
Content.create(:parent_id => parent.id, :user_id => 5,
:description => "I've noticed it very slow lately as well.")

# Thread 5

parent = Content.create(:user_id => 4, :title => "PLEASE READ: Updated plan for Parking Lot work",
...
Content.create(:parent_id => parent.id, :user_id => 2,
:description => "Thank you, Jolena.
\nNo apologies are necessary!!!")

Content.create(:parent_id => parent.id, :user_id => 4,
